        ...
        try:
            ...
            for ownership_row in ownership_data:
                ...
                merged_row = {
                    ...
                    'ملاحظة الأدلة': evidence_note  # Add evidence mapping note
                }
            ...
            if output_path:
                ...
                return send_file(
                    output_path,
                    as_attachment=True,
                    download_name=f"financial_analysis_{quarter_filter}_2025_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx",
